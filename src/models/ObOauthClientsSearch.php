...
/**
 * ObOauthClientsSearch represents the model behind the search form of `sadi01\openbanking\models\ObOauthClients`.
 */
class ObOauthClientsSearch extends ObOauthClients
{
    /**
     * {@inheritdoc}
     */
